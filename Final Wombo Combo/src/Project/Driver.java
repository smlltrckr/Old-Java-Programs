...
public class Driver {
	...
	/**
	 * Populates a Model with a list of generated users
	 * @param rooms the hotel rooms
	 * @return a Model with generated users
	 */
	...
	/**
	 * Populates the list of hotel rooms.
	 * @param rooms the list of hotel rooms
	 */
	 ...
	 * @param end the end int
	 * @return a random int in the given int range
	 */
