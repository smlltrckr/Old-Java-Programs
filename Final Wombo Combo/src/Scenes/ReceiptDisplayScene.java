...
/**
 * Describes what the ReceiptDisplayScene looks like and does.
 * 
 * @author Wombo Combo
 *
 */
...
public class ReceiptDisplayScene extends Scene{
	/**
	 * Constructor for the ReceiptDisplayScene
	 */
	public ReceiptDisplayScene(){
		super("Receipt");
	}
	/**
	 * Adds the components and listeners to the ReceiptDisplayScene
	 */
